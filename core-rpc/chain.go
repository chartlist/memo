...
func (c *Client) EstimateSmartFeeAsync(confTarget int64, estimateMode *btcjson.EstimateSmartFeeMode) FutureEstimateSmartFeeResult {
...
func (c *Client) EstimateSmartFee(confTarget int64) (*btcjson.EstimateSmartFeeResult, error) {
	return c.EstimateSmartFeeWithMode(confTarget, &btcjson.EstimateModeUnset)
}

// EstimateSmartFeeWithMode estimates the approximate fee per kilobyte needed for a transaction
func (c *Client) EstimateSmartFeeWithMode(confTarget int64, estimateMode *btcjson.EstimateSmartFeeMode) (*btcjson.EstimateSmartFeeResult, error) {
...
// Receive waits for the response promised by the future and returns the data
// structure from the server with information about the requested block.
func (r FutureGetBlockVerboseResult) TxVerboseReceive() (*btcjson.GetBlockVerboseTxResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetBlockVerboseTx(blockHash *chainhash.Hash) (*btcjson.GetBlockVerboseTxResult, error) {
	return c.GetBlockVerboseTxAsync(blockHash).TxVerboseReceive()
}
...
func (r FutureGetRawMempoolVerboseResult) ReceiveBytes() ([]byte, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetRawMempoolBytesVerbose() ([]byte, error) {
	return c.GetRawMempoolVerboseAsync().ReceiveBytes()
}
